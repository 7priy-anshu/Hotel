...
// ✅ Capitalized component names & fixed prop handlers
...
const AllRoom = () => {
  ...
  const priceRange = ['0 to 500', '500 to 1000', '1000 to 1500', '1500 to 3000'];
    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="w-full lg:w-3/4">
        ...
        {roomsDummyData.map((room) => (
          <div
            key={room._id}
            className="flex flex-col md:flex-row gap-6 mt-10 pb-10 border-b border-gray-300 last:border-0"
          >
            <img
              onClick={() => {
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <p
                ...
                className="text-gray-800 text-2xl md:text-3xl font-playfair font-semibold cursor-pointer"
              >
                {room.hotel.name}
              </p>

              <p className="text-sm text-gray-600">
                Room Type: <span className="font-medium">{room.roomType}</span>
              </p>
